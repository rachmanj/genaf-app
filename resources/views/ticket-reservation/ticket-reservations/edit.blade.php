...
@section('title_page', 'Edit Ticket Reservation')
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card card-primary card-outline">
                        ...
                        <form action="{{ route('ticket-reservations.update', $ticketReservation) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('ticket_type') is-invalid @enderror"
                                                ...
                                                <option value="flight" {{ old('ticket_type', $ticketReservation->ticket_type) == 'flight' ? 'selected' : '' }}>
                                                    <i class="fas fa-plane"></i> Flight
                                                </option>
                                                <option value="train" {{ old('ticket_type', $ticketReservation->ticket_type) == 'train' ? 'selected' : '' }}>
                                                    <i class="fas fa-train"></i> Train
                                                </option>
                                                <option value="bus" {{ old('ticket_type', $ticketReservation->ticket_type) == 'bus' ? 'selected' : '' }}>
                                                    <i class="fas fa-bus"></i> Bus
                                                </option>
                                                <option value="hotel" {{ old('ticket_type', $ticketReservation->ticket_type) == 'hotel' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('destination') is-invalid @enderror"
                                                id="destination" name="destination" value="{{ old('destination', $ticketReservation->destination) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('departure_date') is-invalid @enderror"
                                                ...
                                                value="{{ old('departure_date', $ticketReservation->departure_date->format('Y-m-d')) }}"
                                                required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('return_date') is-invalid @enderror"
                                                ...
                                                value="{{ old('return_date', $ticketReservation->return_date ? $ticketReservation->return_date->format('Y-m-d') : '') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control @error('cost') is-invalid @enderror"
                                                    id="cost" name="cost" value="{{ old('cost', $ticketReservation->cost) }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('notes') is-invalid @enderror"
                                                ...
                                                placeholder="Enter any additional information about the reservation">{{ old('notes', $ticketReservation->notes) }}</textarea>
                                            @error('notes')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
