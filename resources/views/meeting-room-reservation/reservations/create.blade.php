...
@section('title_page', 'Create Meeting Room Reservation')
@section('breadcrumb_title', 'Create Meeting Room Reservation')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        ...
                        <form action="{{ route('meeting-rooms.reservations.store') }}" method="POST" id="reservation-form">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="requested_room_id" id="requested_room_id" class="form-control @error('requested_room_id') is-invalid @enderror">
                                                ...
                                                @foreach($meetingRooms as $room)
                                                    <option value="{{ $room->id }}" {{ old('requested_room_id') == $room->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="location" id="location" 
                                                ...
                                                value="{{ old('location', 'HO Balikpapan') }}" required>
                                            @error('location')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="meeting_date_start" id="meeting_date_start" 
                                                ...
                                                value="{{ old('meeting_date_start', date('Y-m-d')) }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="participant_count" id="participant_count" 
                                                ...
                                                value="{{ old('participant_count') }}" min="1" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="time" name="meeting_time_start" id="meeting_time_start" 
                                                ...
                                                value="{{ old('meeting_time_start', '08:30') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="time" name="meeting_time_end" id="meeting_time_end" 
                                                ...
                                                value="{{ old('meeting_time_end', '17:00') }}" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="required_facilities" id="required_facilities" rows="2"
                                                ...
                                                placeholder="e.g., Ruang meeting & TV">{{ old('required_facilities') }}</textarea>
