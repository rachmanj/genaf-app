...
namespace App\Http\Controllers\TicketReservation;
...
class TicketReservationController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('ticket-reservation.ticket-reservations.index', compact('employees'));
    }
    ...
    public function create()
    {
        ...
        return view('ticket-reservation.ticket-reservations.create');
    }
    ...
    public function show(TicketReservation $ticketReservation)
    {
        ...
        return view('ticket-reservation.ticket-reservations.show', compact('ticketReservation'));
    }
    ...
    public function edit(TicketReservation $ticketReservation)
    {
        ...
        return view('ticket-reservation.ticket-reservations.edit', compact('ticketReservation'));
    }
