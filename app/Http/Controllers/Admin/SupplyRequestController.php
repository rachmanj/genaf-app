...
class SupplyRequestController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.supply-requests.index');
    }

    public function create()
    {
        $supplies = Supply::orderBy('name')->get();
        return view('admin.supply-requests.create', compact('supplies'));
    }
    ...
    public function show(SupplyRequest $request)
    {
        ...
        return view('admin.supply-requests.show', ['supplyRequest' => $request]);
    }
    ...
    public function edit(SupplyRequest $supplyRequest)
    {
        ...
        return view('admin.supply-requests.edit', compact('supplyRequest', 'supplies'));
    }
