...
class DepartmentStockController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.department-stock.index');
    }
    ...
    public function show(Department $department)
    {
        ...
        return view('admin.department-stock.show', compact('department', 'distributionSummary'));
    }
    ...
    public function report(Department $department)
    {
        ...
        return view('admin.department-stock.report', compact('department', 'distributionSummary'));
    }
}