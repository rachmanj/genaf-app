...
class StockOpnameController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.stock-opname.create', compact('supplies'));
    }
    ...
    public function show(StockOpnameSession $session)
    {
        ...
        return view('admin.stock-opname.show', compact('session'));
    }
    ...
    public function edit(StockOpnameSession $session)
    {
        ...
        return view('admin.stock-opname.edit', compact('session', 'supplies', 'selectedSupplies'));
    }
