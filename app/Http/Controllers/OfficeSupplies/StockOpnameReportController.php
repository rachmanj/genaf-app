...
class StockOpnameReportController extends Controller
{
    public function variance(Request $request)
    {
        ...
        return view('office-supplies.stock-opname.reports.variance');
    }
    ...
    public function accuracy(Request $request)
    {
        ...
        return view('office-supplies.stock-opname.reports.accuracy');
    }
    ...
    public function trends(Request $request)
    {
        ...
        return view('office-supplies.stock-opname.reports.trends', compact('monthlyData', 'reasonData', 'topVarianceItems'));
    }
    ...
    public function history(Request $request)
    {
        ...
        return view('office-supplies.stock-opname.reports.history');
    }
}
