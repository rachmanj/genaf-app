...
class SupplyTransactionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('office-supplies.supply-transactions.index');
    }

    public function create()
    {
        $supplies = Supply::orderBy('name')->get();
        return view('office-supplies.supply-transactions.create', compact('supplies'));
    }
    ...
    public function show(SupplyTransaction $supplyTransaction)
    {
        ...
        return view('office-supplies.supply-transactions.show', compact('supplyTransaction'));
    }
